...
export default function PrivacyPage() {
  return (
    <main className="relative min-h-[100dvh] bg-[#FFFFFF] overflow-x-hidden pt-24">
      <Navbar />
      
      <section className="p-6 md:p-16 lg:p-24 max-w-5xl mx-auto">
        <div className="mb-16">
          <h1 className="font-display font-black text-[clamp(3rem,6vw,6rem)] leading-none uppercase tracking-tighter text-[#121212]">
            PRIVACY<br />POLICY
          </h1>
          <p className="font-mono text-sm tracking-widest text-[#121212]/60 mt-6 uppercase">
            LAST UPDATED: MAR 31, 2026
          </p>
        </div>

        <div className="space-y-12 font-sans text-lg leading-relaxed text-[#121212]/80">
